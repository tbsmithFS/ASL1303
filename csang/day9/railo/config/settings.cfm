<!---
	...
	---><cfset set(dataSourceName="panoramicam")>
...
<!--- Form Helpers --->
	<cfset set(functionName="textField",
			labelPlacement="before", 
			prependToLabel="<div>", 
			append="</div><br />")>
            
	<cfset set(functionName="passwordField",
			labelPlacement="before",
			prependToLabel="<div>",
			append="</div><br />")>
            
	<cfset set(functionName="radioButton",
			labelPlacement="after",
			prepend="<div>",
			appendToLabel="</div><br />")>